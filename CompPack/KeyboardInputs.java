...
public class KeyboardInputs implements KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyChar() == 'p')
			ProgramLogicGateBuilder.up.paused = !ProgramLogicGateBuilder.up.paused;
	}
	...
	public void duplicateBlock() {
		...
		Shape block = ProgramLogicGateBuilder.mouse.selected;	
		...
		if (block instanceof GateNOT)
			block = new GateNOT(ProgramLogicGateBuilder.mouse.mousePos);
		...
		block.moveCenterTo(ProgramLogicGateBuilder.mouse.mousePos);
	}
}
