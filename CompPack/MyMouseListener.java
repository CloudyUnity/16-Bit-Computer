...
public class MyMouseListener implements MouseListener {
	...
	public void update() {
		...
		SwingUtilities.convertPointFromScreen(mousePoint, ProgramLogicGateBuilder.draw);
		mousePos = new Vector2(mousePoint.x, mousePoint.y);
		
		hovered = ProgramLogicGateBuilder.draw.closestInteract();
	...
	public void mousePressed(MouseEvent e) {
		...
		ProgramLogicGateBuilder.draw.requestFocusInWindow();
		...
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			if (hovered instanceof NodeVisible)
				hovered = ((NodeVisible)hovered).drag;
